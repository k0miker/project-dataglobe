...
function Header() {
  ...
  return (
    <header className="flex justify-between items-center bg-glass text-white fixed top-0 left-0 right-0 z-50  md:h-[10%] h-[10%] p-0">
      ...
      <div className="flex items-center justify-end relative md:w-1/3 w-[80%] text-xs md:ml-4">
        {/* Suchfeld */}
        <input
          type="text"
          ...
          className="p-1 rounded border bg-transparent text-white w-1/2 h-8 max-h-8"
        />
        {/* Liste zur Länderauswahl */}
        {searchTerm && (
          <ul className="absolute top-full mt-2 bg-neutral-900 border p-1 w-1/2 text-white text-xs rounded max-h-[50vh] overflow-y-auto z-[1000]">
